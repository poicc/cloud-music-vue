<template>
  <div style="background-color:rgb(39, 40, 41);">
    <v-card class="overflow-hidden">
      ...
      >
        ...
        <v-btn icon @click="logout()">
          <img src="../../assets/images/登出.png" style="width:30px;height:30px;color:white;opacity: 0.6;" />
        </v-btn>
      </v-app-bar>
    ...
    <v-container class="box">
      <v-row>
        <v-col cols="3">
          <v-container>
            <v-card min-height="600" class="overflow-hidden" style="margin-right:50px;">
              <v-navigation-drawer
                v-model="drawer"
                :color="color"
